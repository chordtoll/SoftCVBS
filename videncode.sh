...
make ntsc-decode
make deinterlace
#ffmpeg -i $1 -c:v rawvideo -f rawvideo -vf scale=640:480 -pix_fmt rgb24 - | ./ntsc-encode | ./ntsc-decode | ./deinterlace | ffmpeg -y -f rawvideo -pix_fmt rgb24 -s:v 800x800 -r 30 -i - -filter:v "crop=647:480:19:26" tempencode/vidcvbs.mp4
ffmpeg -i $1 tempencode/vid.mp3
